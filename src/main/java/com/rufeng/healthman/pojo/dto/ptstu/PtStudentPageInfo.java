 ...
 */
@Data
public class PtStudentPageInfo {
    private Long sid;
    ...
    public PtStudentPageInfo(PtStudent student, String clsName, String clgCode, String clgName) {
    ...
    public PtStudentPageInfo(PtStudent student, String clsName) {
