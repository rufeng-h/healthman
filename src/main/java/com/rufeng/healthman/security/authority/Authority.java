...
public class Authority {
    ...
    static {
        ...
        DEFAULT_TEACHER_AUTHORITIES.add(PtClass.CLASS_TEMPLATE);
        ...
        DEFAULT_TEACHER_AUTHORITIES.add(PtStudent.STUDENT_TEMPLATE);
        DEFAULT_TEACHER_AUTHORITIES.add(PtStudent.STUDENT_UPLOAD);
