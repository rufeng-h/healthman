...
CREATE TABLE `pt_admin`  (
  ...
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '$2a$10$5dCCYqDWFjVdKNITPIjvnetqqgIN4XmZ3g8t8y0EN/IZKsiZeznGK',
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'https://picsum.photos/815/778' COMMENT '头像',
  `email` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `admin_desp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 2109 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '用户表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 9189 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '班级表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pt_class_measurement`  (
  ...
  CONSTRAINT `pt_class_measurement_ibfk_3` FOREIGN KEY (`cms_created_admin`) REFERENCES `pt_admin` (`admin_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 95 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '班级、测量中间表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 361 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '学院表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pt_measurement`  (
  ...
  CONSTRAINT `pt_measurement_ibfk_3` FOREIGN KEY (`ms_created_admin`) REFERENCES `pt_admin` (`admin_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '测量记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pt_oper_log`  (
  ...
  `oper_module` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '操作模块',
  `oper_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '操作类型',
  ...
  `oper_res` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '返回结果',
  ...
  `oper_created_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`oper_id`) USING BTREE,
  INDEX `oper_admin_id`(`oper_admin_id`) USING BTREE,
  CONSTRAINT `pt_oper_log_ibfk_1` FOREIGN KEY (`oper_admin_id`) REFERENCES `pt_admin` (`admin_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '操作记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pt_role`  (
  ...
  CONSTRAINT `pt_role_ibfk_1` FOREIGN KEY (`admin_id`) REFERENCES `pt_admin` (`admin_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 2118 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '角色表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2090979 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '成绩表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pt_student`  (
  ...
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '$2a$10$5dCCYqDWFjVdKNITPIjvnetqqgIN4XmZ3g8t8y0EN/IZKsiZeznGK' COMMENT '登陆密码',
...
) ENGINE = InnoDB AUTO_INCREMENT = 148637 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '学生表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 859 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '年级、性别对应的测试科目' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pt_subgroup`  (
  ...
  CONSTRAINT `pt_subgroup_ibfk_1` FOREIGN KEY (`grp_created_admin`) REFERENCES `pt_admin` (`admin_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '科目组' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pt_subject_subgroup`  (
  ...
  CONSTRAINT `pt_subject_subgroup_ibfk_3` FOREIGN KEY (`sub_grp_admin`) REFERENCES `pt_admin` (`admin_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 55 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '科目与科目组关联' ROW_FORMAT = Dynamic;
