...
class ShortRunning:
    ...
    def _data(self, gender):
        arg1 = (-20, 255) if gender == 'M' else (20, 265)
        arg2 = (30, 200) if gender == 'M' else (60, 200)
...
Path(f'./data/sitting_forward{gender}.json').write_text(json.dumps(data, ensure_ascii=False, indent=4), encoding='utf-8')
