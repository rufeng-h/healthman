...
class ShortRunning:
    ...
    def _data(self, gender):
        arg1 = (180, 280) if gender == 'M' else (120, 210)
        arg2 = (200, 250) if gender == 'M' else (150, 190)
...
Path(f'./data/jump{gender}.json').write_text(json.dumps(data, ensure_ascii=False, indent=4), encoding='utf-8')
